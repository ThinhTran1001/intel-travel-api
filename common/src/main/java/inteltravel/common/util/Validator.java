 ...
 */
package inteltravel.common.util;
...
public class Validator {
    ...
    public static boolean isPasswordRegex(String password) {
        if (password.length() < inteltravel.common.constant.Constants.DEFAULT_PASSWORD_LENGTH_MIN
                || password.length() > inteltravel.common.constant.Constants.DEFAULT_PASSWORD_LENGTH_MAX){
            return false;
        }
