...
public interface LabelKey {
    ...
    public static final String SUCCESS_SIGN_UP_SUCCESS = "success.signup-success";
    public static final String SUCCESS_VERIFY_OTP_SUCCESS = "success.verify-otp-success";
    ...
    public static final String ERROR_ADDRESS_IS_EMPTY = "error.address-is-empty";
    ...
    public static final String ERROR_DATE_IS_AFTER_CURRENT_DATE = "error.date-is-after-current-date";
